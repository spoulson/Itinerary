// $ANTLR 3.2 Sep 23, 2009 12:02:23 TimeDef.g 2011-06-10 10:45:42
...
public partial class TimeDefLexer : Lexer {
    ...
    public void mALPHA() // throws RecognitionException [2]
    {
            ...
            int _type = ALPHA;
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // TimeDef.g:221:6: ( ( 'A' .. 'Z' | 'a' .. 'z' )+ )
            // TimeDef.g:221:8: ( 'A' .. 'Z' | 'a' .. 'z' )+
            {
            	// TimeDef.g:221:8: ( 'A' .. 'Z' | 'a' .. 'z' )+
            	int cnt2 = 0;
            	do 
    ...
    const string DFA4_eotS =
        ...
        "\x03\uffff\x01\x26\x07\uffff\x06\x19\x01\uffff\x01\x2e\x04\uffff"+
        "\x06\x19\x02\uffff\x03\x19\x01\x38\x01\x39\x01\x3a\x01\x19\x01\x3c"+
        "\x01\x3d\x03\uffff\x01\x19\x02\uffff\x01\x3f\x01\uffff";
    const string DFA4_eofS =
        "\x40\uffff";
    const string DFA4_minS =
        "\x01\x09\x01\x61\x01\x76\x01\x69\x01\x72\x01\x65\x01\x6f\x03\uffff"+
        "\x01\x41\x03\uffff\x02\x26\x03\uffff\x01\x41\x07\uffff\x01\x73\x01"+
        "\x65\x01\x6e\x01\x6f\x01\x65\x01\x69\x01\uffff\x01\x26\x04\uffff"+
        "\x01\x74\x01\x72\x01\x63\x01\x6e\x01\x6b\x01\x64\x02\uffff\x01\x69"+
        "\x01\x79\x01\x65\x03\x41\x01\x6e\x02\x41\x03\uffff\x01\x67\x02\uffff"+
        "\x01\x41\x01\uffff";
    const string DFA4_maxS =
        "\x01\x7c\x01\x61\x01\x76\x01\x69\x01\x72\x01\x65\x01\x6f\x03\uffff"+
        "\x01\x7a\x03\uffff\x02\x26\x03\uffff\x01\x7a\x07\uffff\x01\x73\x01"+
        "\x65\x01\x6e\x01\x6f\x01\x65\x01\x69\x01\uffff\x01\x26\x04\uffff"+
        "\x01\x74\x01\x72\x01\x63\x01\x6e\x01\x6b\x01\x64\x02\uffff\x01\x69"+
        "\x01\x79\x01\x65\x03\x7a\x01\x6e\x02\x7a\x03\uffff\x01\x67\x02\uffff"+
        "\x01\x7a\x01\uffff";
    const string DFA4_acceptS =
        ...
        "\x01\x16\x01\x0f\x01\x12\x01\x15\x06\uffff\x01\x0e\x01\x11\x09\uffff"+
        "\x01\x04\x01\x05\x01\x06\x01\uffff\x01\x02\x01\x03\x01\uffff\x01"+
        "\x01";
    ...
    static readonly string[] DFA4_transitionS = {
            ...
            "\x06\x19\x01\x03\x02\x19\x01\x06\x01\x05\x01\x0a\x02\x19\x01"+
            "\uffff\x01\x10",
            "\x01\x1b",
            "\x01\x1c",
            "\x01\x1d",
