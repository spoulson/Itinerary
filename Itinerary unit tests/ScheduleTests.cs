...
namespace Expl.Itinerary.Test {
   ...
   public class ScheduleTests {
      ...
      public void LimitTest() {
         ScheduleUnitTest[] tests = {
            new ScheduleUnitTest("Test inner limit",
               new LimitSchedule(
                  new DateTime(2008, 9, 3, 11, 0, 0), new DateTime(2008, 9, 3, 12, 0, 0),
                  new OneTimeSchedule(new DateTime(2008, 9, 3, 0, 0, 0), new TimeSpan(20, 0, 0))
               ),
               new TimedEvent[] {
                  new TimedEvent(new DateTime(2008, 9, 3, 0, 0, 0), new TimeSpan(20, 0, 0))
               }
            ),
            new ScheduleUnitTest("Test outer limit",
               new LimitSchedule(
                  new DateTime(2008, 9, 3, 0, 0, 0), new DateTime(2008, 9, 3, 20, 0, 0),
                  new OneTimeSchedule(new DateTime(2008, 9, 3, 11, 0, 0), new TimeSpan(1, 0, 0))
               ),
               new TimedEvent[] {
                  new TimedEvent(new DateTime(2008, 9, 3, 11, 0, 0), new TimeSpan(1, 0, 0))
               }
            ),
            new ScheduleUnitTest("Test left limit",
               new LimitSchedule(
                  new DateTime(2008, 9, 3, 0, 0, 0), new DateTime(2008, 9, 3, 12, 0, 0),
                  new OneTimeSchedule(new DateTime(2008, 9, 3, 11, 0, 0), new TimeSpan(4, 0, 0))
               ),
               new TimedEvent[] {
                  new TimedEvent(new DateTime(2008, 9, 3, 11, 0, 0), new TimeSpan(4, 0, 0))
               }
            ),
            new ScheduleUnitTest("Test right limit",
               new LimitSchedule(
                  new DateTime(2008, 9, 3, 12, 0, 0), new DateTime(2008, 9, 3, 20, 0, 0),
                  new OneTimeSchedule(new DateTime(2008, 9, 3, 11, 0, 0), new TimeSpan(4, 0, 0))
               ),
               new TimedEvent[] {
                  new TimedEvent(new DateTime(2008, 9, 3, 11, 0, 0), new TimeSpan(4, 0, 0))
            ...
            new ScheduleUnitTest("Test left of limit",
               new LimitSchedule(
                  new DateTime(2008, 9, 4, 0, 0, 0), new DateTime(2008, 9, 4, 12, 0, 0),
                  new OneTimeSchedule(new DateTime(2008, 9, 3, 11, 0, 0), new TimeSpan(4, 0, 0))
               ),
               new TimedEvent[] { }
            ),
            new ScheduleUnitTest("Test right of limit",
               new LimitSchedule(
                  new DateTime(2008, 9, 2, 0, 0, 0), new DateTime(2008, 9, 2, 12, 0, 0),
                  new OneTimeSchedule(new DateTime(2008, 9, 3, 11, 0, 0), new TimeSpan(4, 0, 0))
               ),
               new TimedEvent[] { }
            ),
            new ScheduleUnitTest("Test inner limit range",
               new LimitSchedule(
                  new DateTime(2008, 9, 3, 11, 0, 0), new DateTime(2008, 9, 3, 12, 0, 0),
                  new OneTimeSchedule(new DateTime(2008, 9, 3, 0, 0, 0), new TimeSpan(20, 0, 0))
               ),
               new DateTime(2008, 9, 3, 0, 0, 0), new DateTime(2008, 9, 3, 22, 0, 0),
               new TimedEvent[] {
                  new TimedEvent(new DateTime(2008, 9, 3, 0, 0, 0), new TimeSpan(20, 0, 0))
               }
            ),
            new ScheduleUnitTest("Test outer limit range",
               new LimitSchedule(
                  new DateTime(2008, 9, 3, 0, 0, 0), new DateTime(2008, 9, 3, 20, 0, 0),
                  new OneTimeSchedule(new DateTime(2008, 9, 3, 11, 0, 0), new TimeSpan(1, 0, 0))
               ),
            ...
            new ScheduleUnitTest("Test left limit range",
               new LimitSchedule(
                  new DateTime(2008, 9, 3, 0, 0, 0), new DateTime(2008, 9, 3, 12, 0, 0),
                  new OneTimeSchedule(new DateTime(2008, 9, 3, 11, 0, 0), new TimeSpan(4, 0, 0))
               ),
            ...
            new ScheduleUnitTest("Test right limit range",
               new LimitSchedule(
                  new DateTime(2008, 9, 3, 12, 0, 0), new DateTime(2008, 9, 3, 20, 0, 0),
                  new OneTimeSchedule(new DateTime(2008, 9, 3, 11, 0, 0), new TimeSpan(4, 0, 0))
               ),
            ...
            new ScheduleUnitTest("Test left of limit range",
               new LimitSchedule(
                  new DateTime(2008, 9, 4, 0, 0, 0), new DateTime(2008, 9, 4, 12, 0, 0),
                  new OneTimeSchedule(new DateTime(2008, 9, 3, 11, 0, 0), new TimeSpan(4, 0, 0))
               ),
            ...
            new ScheduleUnitTest("Test right of limit range",
               new LimitSchedule(
                  new DateTime(2008, 9, 2, 0, 0, 0), new DateTime(2008, 9, 2, 12, 0, 0),
                  new OneTimeSchedule(new DateTime(2008, 9, 3, 11, 0, 0), new TimeSpan(4, 0, 0))
               ),
            ...
            new ScheduleUnitTest("Test interval",
               new LimitSchedule(
                  new DateTime(2008, 9, 3, 0, 0, 0), new DateTime(2008, 9, 3, 4, 0, 0),
                  new IntervalSchedule(new TimeSpan(0, 30, 0), new TimeSpan(0, 10, 0), DateTime.MinValue)
               ),
               new TimedEvent[] {
                  new TimedEvent(new DateTime(2008, 9, 3, 0, 0, 0), new TimeSpan(0, 10, 0)),
                  new TimedEvent(new DateTime(2008, 9, 3, 0, 30, 0), new TimeSpan(0, 10, 0)),
                  new TimedEvent(new DateTime(2008, 9, 3, 1, 0, 0), new TimeSpan(0, 10, 0)),
                  new TimedEvent(new DateTime(2008, 9, 3, 1, 30, 0), new TimeSpan(0, 10, 0)),
                  new TimedEvent(new DateTime(2008, 9, 3, 2, 0, 0), new TimeSpan(0, 10, 0)),
                  new TimedEvent(new DateTime(2008, 9, 3, 2, 30, 0), new TimeSpan(0, 10, 0)),
                  new TimedEvent(new DateTime(2008, 9, 3, 3, 0, 0), new TimeSpan(0, 10, 0)),
                  new TimedEvent(new DateTime(2008, 9, 3, 3, 30, 0), new TimeSpan(0, 10, 0))
               }
            ),
            new ScheduleUnitTest("Test interval range",
               new LimitSchedule(
                  new DateTime(2008, 9, 3, 0, 0, 0), new DateTime(2008, 9, 3, 4, 0, 0),
                  new IntervalSchedule(new TimeSpan(0, 30, 0), new TimeSpan(0, 10, 0), DateTime.MinValue)
               ),
               new DateTime(2008, 9, 2, 0, 0, 0), new DateTime(2008, 9, 5, 0, 0, 0),
               new TimedEvent[] {
                  new TimedEvent(new DateTime(2008, 9, 3, 0, 0, 0), new TimeSpan(0, 10, 0)),
                  new TimedEvent(new DateTime(2008, 9, 3, 0, 30, 0), new TimeSpan(0, 10, 0)),
                  new TimedEvent(new DateTime(2008, 9, 3, 1, 0, 0), new TimeSpan(0, 10, 0)),
            ...
            new ScheduleUnitTest("Test interval narrow range",
               new LimitSchedule(
                  new DateTime(2008, 9, 3, 0, 0, 0), new DateTime(2008, 9, 3, 4, 0, 0),
                  new IntervalSchedule(new TimeSpan(0, 30, 0), new TimeSpan(0, 10, 0), DateTime.MinValue)
               ),
               new DateTime(2008, 9, 3, 1, 0, 0), new DateTime(2008, 9, 3, 3, 0, 0),
               new TimedEvent[] {
                  new TimedEvent(new DateTime(2008, 9, 3, 1, 0, 0), new TimeSpan(0, 10, 0)),
                  new TimedEvent(new DateTime(2008, 9, 3, 1, 30, 0), new TimeSpan(0, 10, 0)),
                  new TimedEvent(new DateTime(2008, 9, 3, 2, 0, 0), new TimeSpan(0, 10, 0)),
