      ...
      public static readonly IExampleItem[] ExampleList = {
         ...
         new ExampleGroup("Days of the week") {
            Items = new IExampleItem[] {
               ...
               new ExampleSchedule("Weekends", "every T7.0:0:0 since 2008-01-05 lasting T2.0:0:0"),
               new ExampleSchedule("Weekdays", "(every T1.0:0:0 lasting T1.0:0:0 !&& every T7.0:0:0 since 2008-01-05 lasting T2.0:0:0)"),
            }
         },
